...
class CandidatesController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('CentreStaff/Candidates/Index', ['candidates' => $candidates]);
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('CentreStaff/Candidates/View', ['candidate' => $candidate, 'registrations' => $registrations]);
    }
