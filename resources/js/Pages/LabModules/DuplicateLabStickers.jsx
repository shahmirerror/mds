...
export default function DuplicateLabStickers({auth}) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Duplicate Lab Sticker</h2>}
        >
            <Head title="Duplicate Lab Sticker" />
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <div className="row g-5 mb-3">
                                                ...
                                                <div className="col-4">
                                                    <button className={'btn btn-md btn-outline-info  mt-6'} disabled={false} onChange={handleSearch}>Search for Candidate</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
