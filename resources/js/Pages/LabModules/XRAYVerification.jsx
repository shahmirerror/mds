...
export default function XRAYVerification({auth}) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">XRAY Verification (Sticker)</h2>}
        >
            <Head title="XRAY Verification (Sticker)" />
