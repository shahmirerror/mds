...
export default function Country(props) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('country-setup.store'));
    }

    const handleUpdate = (e) => {
        e.preventDefault();

        put(route('country-setup.update', data.id));
    }
    ...
    const handleDelete = (id) => {
        ...
        deleteResource(route(`country-setup.destroy`, id));
    };

    return (
        <AuthenticatedLayout
            user={props.auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Country Setup</h2>}
        >
            <Head title="Country Setup" />
                ...
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="Country name" name="name" onChange={handleChange}/>
                        </div>
                    </div>
            ...
            <div className="modal modal-blur fade" id="edit-user" tabindex="-1" role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            <label className="form-label">Name</label>
                            <input type="text" className="form-control" placeholder="Country name" name="name" value={data.name} onChange={handleChange}/>
                        </div>
                    </div>
                    <div className="modal-footer">
                        <a href="#" className="btn btn-link link-secondary" data-bs-dismiss="modal">
            ...
            <div className="modal modal-blur fade" id="delete-user" tabindex="-1" role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    ...
                    <div className="modal-body">
                        <span>Are you sure you want to delete country?</span>
                    </div>
                    <div className="modal-footer">
                        <a href="#" className="btn btn-link link-secondary" data-bs-dismiss="modal">
                            Cancel
