...
export default function Profession(props) {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('profession-setup.store'));
    }

    const handleUpdate = (e) => {
        e.preventDefault();

        put(route('profession-setup.update', data.id));
    }
    ...
    const handleDelete = (id) => {
        ...
        deleteResource(route(`profession-setup.destroy`, id));
    };

    return (
        <AuthenticatedLayout
            user={props.auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Profession Setup</h2>}
        >
            <Head title="Profession Setup" />
                            ...
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-tbody">
                                        {props.profession.map((data, index) => (
                                        <tr>
                ...
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Create Profession</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                    <div className="modal-body">
                        <div className="mb-3">
                            <label className="form-label">Name</label>
                            <input type="text" className="form-control" placeholder="Profession Name" name="name" onChange={handleChange}/>
                        </div>
                    </div>
            ...
            <div className="modal modal-blur fade" id="edit-user" tabindex="-1" role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            <label className="form-label">Name</label>
                            <input type="text" className="form-control" placeholder="Profession" name="name" value={data.name} onChange={handleChange}/>
                        </div>
                    </div>
                    <div className="modal-footer">
                        <a href="#" className="btn btn-link link-secondary" data-bs-dismiss="modal">
            ...
            <div className="modal modal-blur fade" id="delete-user" tabindex="-1" role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                    ...
                    <div className="modal-body">
                        <span>Are you sure you want to delete profession?</span>
                    </div>
                    <div className="modal-footer">
                        <a href="#" className="btn btn-link link-secondary" data-bs-dismiss="modal">
                            Cancel
