...
export default function View(props) {
    ...
    const getReg = (e, id) => {
        ...
        try {
            const response = fetch(route("staff.candidate.fetch_reg", id), {
                method: "GET"
            })
                .then(res => res.json())
                .then(
    ...
    const getMed = (e, id) => {
        ...
        try {
            const response = fetch(route("staff.candidate.fetch_medical", id), {
                method: "GET"
            })
                .then(res => res.json())
                .then(
    ...
    const getLab = (e, id) => {
        ...
        try {
            const response = fetch(route("staff.candidate.fetch_lab", id), {
                method: "GET"
            })
                .then(res => res.json())
                .then(
    ...
    const getXray = (e, id) => {
        ...
        try {
            const response = fetch(route("staff.candidate.fetch_xray", id), {
                method: "GET"
            })
                .then(res => res.json())
                .then(
