                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td>
                                <Link href={route('candidates-in-centre.show', cand?.candidate_id)}>{cand?.candidate_name}</Link>
                            </td>
                            <td>
                                <span class="text-secondary">
                                    <Link href={route('candidates-in-centre.show', cand?.candidate_id)}>{cand?.passport_no}</Link>
                                </span>
                            </td>
                            <td>
                                <span class="text-secondary">
                                    <Link href={route('candidates-in-centre.show', cand?.candidate_id)}>{cand?.cnic}</Link>
                                </span>
                            </td>
                            <td>
